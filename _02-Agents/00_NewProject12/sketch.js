...
function draw() {
    ...
    if((counter<=0)){
    ...
    }else if(((timestamp()-redrawTime)>500)){
        ...
        for(let i=0;i<numOfDiamonds;i++){
            ...
            if(move<(-0.1)){
                ...
                if(elevatorScaler<windowHeight1){
                    elevatorScaler=elevatorScaler*1.01;
                }else{
            ...
            if(elevatorScaler<0.1*windowHeight1){elevatorScaler=0.1*windowHeight1;}
        }
