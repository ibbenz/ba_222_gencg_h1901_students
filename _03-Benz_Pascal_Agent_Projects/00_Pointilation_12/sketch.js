...
var oldtime;
var rand_rect;
//Das unterlagerte Rechteck des Diamanten.
let rand_rect2;

//Die Farben für das Rechteck des Diamanten.
var rectColor;
var backgroundColor;
var mixColor;
...
//Die Elemente die gezeichnet werden.
let diamant;
let redrawTime = 0;
let reFadeTime = 0;
...
function draw() {
    ...
    if ((counter <= 0)) {
        ...
        //Es werden Diamanten in den Grundfarben gezeichnet
...
//Ein Rechteck für meine Diamanten.
...
//Die Klasse für den gesamten Diamanten.
//Der Diamant besteht aus zwei ueberlagerten Rechnecken mit vier Verbindungskanten.
class Diamond {
