...
function draw() {
    ...
    if(rectWidth>rectHeight){
        radiusBase=rectHeight;
    }else{
        radiusBase=rectWidth;
    }
    ...
    rand_rect2=new randomRectangle(rectPosX,rectPosY,rectWidth,rectHeight,rectColor,opacity,1,radiusArray);
    rand_rect=new randomRectangle(rectPosX+shiftRectX,rectPosY+shiftRectY,rectWidth,rectHeight,rectColor,opacity,1,radiusArray);
    rand_rect2.draw();

    //Verbindungslinie zwischen oberem und unterem Rechteck
    //unteres Rechteck
    linePoint1=createVector(rectPosX+radiusArray[0],rectPosY+radiusArray[0]);
    //point(linePoint1.x,linePoint1.y);
    linePoint2=createVector(rectPosX+rectWidth-radiusArray[1],rectPosY+radiusArray[1]);
    //point(linePoint2.x,linePoint2.y);
    linePoint3=createVector(rectPosX+radiusArray[3],rectPosY+rectHeight-radiusArray[3]);
    //point(linePoint3.x,linePoint3.y);
    linePoint4=createVector(rectPosX+rectWidth-radiusArray[2],rectPosY+rectHeight-radiusArray[2]);
    ...
    stroke(rectColor[0],rectColor[1],rectColor[2],opacity);
