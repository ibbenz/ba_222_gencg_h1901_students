...
function draw() {
    ...
    //rectPosX=1500;
    //rectPosY=600;
    rectPosX=random(windowWidth1/10,windowWidth1/2);
    rectPosY=random(windowHeight1/10,windowHeight1/2);
    ...
    if(currentDiamondNumber<(numOfDiamonds-1)) {
    ...
    //wir zeichnen die Diamanten nach einer gewissen Zeit wieder:

    for(let i=0;i<currentDiamondNumber;i++){
/*        if(i<currentDiamondNumber){
            console.log("Get Opacity: "+diamondList[i].getOpacity());
            diamondList[i].setOpacity(opacityScale*diamondList[i].getOpacity());
            console.log("Get Opacity2: "+diamondList[i].getOpacity());
        }*/
