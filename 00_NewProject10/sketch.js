    ...
    if((counter<=0)){
        ...
        for(let i=0;i<numOfDiamonds;i++){
            ...
            if(move<(-0.1)){
                ...
                rectPosY=random(1.2*windowHeight1-elevatorScaler,windowHeight1);
                console.log("elevatorScaler:"+rectPosY);
            } else if(move>(0.1)){
                elevatorScaler=elevatorScaler*0.99;
                rectPosY=random(0,elevatorScaler+0.2*windowHeight1);
            } else{
                move=0;
                if(elevatorScaler<windowHeight1){elevatorScaler=elevatorScaler*1.01;}else{
                    elevatorScaler=windowHeight1;
                }}
